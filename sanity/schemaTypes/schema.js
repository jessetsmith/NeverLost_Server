    ...
    fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          {name: 'height', title: 'Ceiling Height', type: 'number'},
          {name: 'unit', title: 'Unit', type: 'string', options: {list: ['ft', 'm']}},
          {name: 'roomShape', title: 'Room Shape', type: 'string'},
          {name: 'wallsEnabled', title: 'Walls Enabled', type: 'boolean'},
          {name: 'wallColor', title: 'Wall Color', type: 'string'},
          {name: 'wallThickness', title: 'Wall Thickness', type: 'number'},
          {name: 'floorplanUrl', title: 'Floorplan URL', type: 'url'},
          {name: 'floorplanVisible', title: 'Floorplan Visible', type: 'boolean'},
          {name: 'floorplanOpacity', title: 'Floorplan Opacity', type: 'number'},
          {name: 'floorplanRotation', title: 'Floorplan Rotation', type: 'number'},
          {name: 'floorplanOffsetX', title: 'Floorplan Offset X', type: 'number'},
          {name: 'floorplanOffsetZ', title: 'Floorplan Offset Z', type: 'number'},
        ],
      },
      {
        name: 'sceneSettings',
